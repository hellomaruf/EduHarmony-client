        ...
        <Slide direction="right" cascade damping={0.1}>
          <div className=" p-6 space-y-2 rounded-2xl transition duration-300 hover:text-white hover:bg-[#7330FF]  bg-gray- shadow-lg">
            ...
            <p className="text-sm">
              ...
              partnerships. Distinctively productize top-line process
              improvements.
            </p>
          ...
          <div className=" p-6 space-y-2 rounded-2xl transition duration-300 hover:text-white hover:bg-[#7330FF]  bg-gray- shadow-lg">
            ...
            <p className="text-sm">
              Collaboratively expedite optimal sources before synergistic
              quality vectors. Monotonectally actualize long-term high-impact
              total linkage.
            </p>
            <button className="flex items-center  font-medium">
              Discover More
