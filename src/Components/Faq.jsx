      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2   justify-center gap-5 my-10 pt-4">
        <div className=" space-y-5">
          <Slide cascade damping={0.1}>
            ...
            <p>
              Welcome to our FAQ section! Here youll find answers to the most
              common questions about our services, products, and policies. If
              you cant find what youre looking for, feel free to contact our
              support team.
            </p>
          ...
          <Slide direction="right" cascade damping={0.1}>
            ...
            >
              ...
              <p className="mt-4 leading-relaxed text-gray-700">
                ...
                right corner of the homepage. Fill in the required details and
            ...
            <details className="group border-s-4 rounded-xl border-[#7330ff] bg-gray-50 p-6 [&_summary::-webkit-details-marker]:hidden">
              ...
              <p className="mt-4 leading-relaxed text-gray-700">
                ...
                registered email address, and well send you instructions on how
